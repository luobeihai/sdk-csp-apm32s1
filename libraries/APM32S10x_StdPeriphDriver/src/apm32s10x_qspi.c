...
/*!
 * @brief       Configure the QSPI peripheral according to the specified parameters in the qspiConfig
 *
...
/*!
 * @brief       Fill each qspiConfig member with its default value
 *
...
/*!
 * @brief       Congfigure Tx FIFO threshold
 *
...
/*!
 * @brief       Congfigure Tx FIFO empty threshold
 *
...
/*!
 * @brief       Configure RX sample edge
 *
...
/*!
 * @brief       Configure instruction and address type
 *
...
/*!
 * @brief       Configure wait cycle number
 *
